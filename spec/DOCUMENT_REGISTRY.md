...
|---------|-------|-----------|
| **Authoritative Reference** | 15 | All 10 spec files + README, app/README, DOCUMENT_REGISTRY, PERMISSIONS_REVIEW, RULES_VALIDATION_REPORT |
