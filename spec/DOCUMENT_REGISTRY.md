...
|--------|-------|-----------|
| **STRICTLY_DISALLOWED** | 4 | DECISIONS.md, AUTHORITY.md, SYSTEM_PROMPT.md, COMMENT_HEADERS.md, RULES_VALIDATION_REPORT_HUMAN.md |
| **ALLOWED_AND_INFORM** | 9 | README.md, CLAUDE.md, app/README.md, IMPLEMENTATION_CHECKLIST.md, WORKFLOW.md, CHANGE_REQUEST_PROMPT.md, DOCUMENT_REGISTRY.md, PERMISSIONS_REVIEW.md, RULES_VALIDATION_REPORT.md |
| **ALLOWED_WITH_HUMAN_PR_REVIEW** | 7 | DATA_CONTRACTS.md, TYPES.md, UI_BEHAVIOR.md, EXAMPLES.md, UI_STYLE_GUIDE.md, TERMINOLOGY.md |
...
|---------|-------|-----------|
| **Authoritative Reference** | 14 | All 9 spec files + README, app/README, DOCUMENT_REGISTRY, PERMISSIONS_REVIEW, RULES_VALIDATION_REPORT |
...
- **Can EDIT**: README.md, app/README.md, IMPLEMENTATION_CHECKLIST.md, RULES_VALIDATION_REPORT.md, DOCUMENT_REGISTRY.md
